...
if($this->session->has_userdata('user_id')){
  redirect('index.php/main/Maintance_Dashboard');
}else{
?>
...
<html lang="en">
    ...
    <div class="alert alert-danger alert-dismissible show fade">
            ...
            <form method="POST" name="form1"  action="<?php echo base_url("index.php/Main/maintance_login") ?>">
...
<script>
    window.onload = function(){
        window.location.href="http://192.168.40.3:2000/DMM/index.php/Main/loginPage1";
