...
<div class="row"><div class="col-md-2 " >
 ...
 <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" name="SecID" value="<?php Echo $id;?>">
                         ...
                         <div class="col-md-3">
<button type="submit" class="btn btn-info btn-sm ">  Add Machines
                        </button>
...
?>
                            ...
                            <div class="col-md-3">
                                 <form action="<?php echo base_url("index.php/Machines/updatemac") ?>" method="post" class="form" >
  ...
  <div class="custom-control custom-switch">
                                                                <input type="checkbox" name="onoffswitch" class="custom-control-input" id="customSwitch<?php Echo $f->DMID;?>" checked>
                                                                <label class="custom-control-label" for="customSwitch<?php Echo $f->DMID;?>"></label>
                                                            </div>
</div>
<div class="col-md-3">
                                ...
                                <div class="p-3 bg-primary-300 rounded overflow-hidden position-relative text-white mb-g">
                                    <div class="">
                                        <h3 class="display-4 d-block l-h-n m-0 fw-500">
                                            ...
                                            <small class="m-0 l-h-n"><?php Echo $f->MachineName;?></small>
                                        </h3>
                                    </div>
...
if(empty($data['Checkmaintance'])){
 ?>
 <spam><a href="<?php echo base_url("index.php/machines/sectionwisemachine/$f->DMID") ?>" class="small-box-footer" style="color:white;"> Pending More info <i class="fas fa-circle-right"></i></a>
</spam>
 <?php
  ...
  ?>
   <spam>
  <a href="<?php echo base_url("index.php/machines/sectionwisemachine/$f->DMID") ?>" class="small-box-footer"  style="color:white;">Maintance Done <i class="fas fa-check-circle"></i></a>
