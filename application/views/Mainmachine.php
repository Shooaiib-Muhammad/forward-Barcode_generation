<?php $this->load->view('includes/new_header'); ?>
        ...
        <div class="col-md-6">
         <div class="col-md-12" style="background-color: #559CE4; color: #fff; ">
        <h5><i class="fa fa-plus"></i> Add New Schedule</h5>
        </div>
<div class="row">
...
<div class="form-group">
         ...
         $Day=date('d');
          $date = $Year . '-' . $Month . '-' . $Day;
                            ?>
                            <input name="date" id="date" value="<?php echo $date; ?>" class="form-control" type="date">
                        </div>
                    </div>
    ...
    <input type="checkbox" name="status" class="onoffswitch-checkbox" id="status" tabindex="0" checked>
    ...
    <div class="col-md-8">
     <div class="col-md-12" style="background-color: #559CE4; color: #fff; margin-top:-100px; ">
        <h5><i class="fa fa-plus"></i> Add New Peremerters</h5>
        </div>
     <div class="row">
    <div class="col-md-4">
 ...
 <input type="hidden" name="department" value="<?php echo $DeptID; ?>"></input>
                   <input type="hidden" name="section" id="SECID" value="<?php echo $SectionID; ?>"></input>
                    ...
                    <div class="col-md-4">
                     ...
                     <button type="submit" class="btn btn-primary btn-md">Add New Parameter</button>
                     </form>
                    </div>
                    </div>
         <table class="table table-hover table-strippesd  table-sm">
...
<?php
    ...
    <div class="row example">
     ...
     <div class="col-md-4">
                       <label >Schedule Strat Date</label>
